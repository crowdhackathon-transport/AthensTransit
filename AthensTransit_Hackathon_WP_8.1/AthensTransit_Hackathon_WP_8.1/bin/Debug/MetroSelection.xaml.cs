...
namespace AthensTransit_Hackathon
{
    ...
    /// </summary>
    public sealed partial class metroSelection : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            m2.Content = "ΑΝΘΟΥΠΟΛΗ - ΕΛΛΗΝΙΚΟ";
            m3.Content = "ΑΓΙΑ ΜΑΡΙΝΑ - Δ.ΠΛΑΚΕΝΤΙΑΣ";
            m3air.Content = "ΑΓΙΑ ΜΑΡΙΝΑ - ΑΕΡΟΔΡΟΜΙΟ";
        }
        ...
        private void m3air_Click(object sender, RoutedEventArgs e)
        {
            App.LoadBus("m3 ");
            Frame.Navigate(typeof(TimeSchedule));
        }
