...
namespace AthensTransit_Hackathon
{
    ...
    /// </summary>
    public sealed partial class tramSelection : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            //trainLine.Text = "ΕΠΙΛΟΓΗ ΤΡΕΝΟΥ";

            //t3.Content = "ΝΕΟ ΦΑΛΗΡΟ - ΒΟΥΛΑ";
            //t4.Content = "ΣΥΝΤΑΓΜΑ - ΝΕΟ ΦΑΛΗΡΟ";
            //t5.Content = "ΣΥΝΤΑΓΜΑ - ΒΟΥΛΑ";

            var loader = new Windows.ApplicationModel.Resources.ResourceLoader();
            trainLine.Text = loader.GetString("chooseTrain");

            t3.Content = loader.GetString("t3");
            t4.Content = loader.GetString("t4");
            t5.Content = loader.GetString("t5");
        }
